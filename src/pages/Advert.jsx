        ...
        <div className="w-[90%] m-auto p-6 lg:px-32 lg:py-16 rounded-lg grid place-items-center shadow-md bg-n-n6">
          ...
          <form action="" className="mt-6 sm:mt-8 w-full">
            ...
            <div className="flex gap-4 items-center p-4 bg-white justify-center border-2 border-dashed">
              ...
              <p className="">Upload an image for your restaurant banner (GIF,JPG or PNG)  </p>
              <label htmlFor="file" className="inline-block box-border border-2 pointer bg-p-button p-3 rounded-md text-n-n7 text-xs lg:text-sm font-pop hover:text-p-button hover:bg-n-n7 ">Browse</label>
